...
class Generator {
    ...
    render(md) {
        let self = this;
        return M1.compile(md, function(node) {
...
M.parse = function(md) {
    return M1.compile(md, G.treeGen);
};
M.newHtmlRender = function(options1) {
